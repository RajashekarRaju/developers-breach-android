...
class AppActions(
    ...
    val homeToArticlesCategory = {
        navController.navigate(routes.ARTICLES_CATEGORY_ROUTE)
    }
    ...
    val articleDetailToWebView = {
        navController.navigate(routes.ARTICLE_WEB_VIEW_ROUTE)
    }

    val articleDetailToBanner = {
        navController.navigate(routes.BANNER_ROUTE)
    }
    ...
    val optionsToAuthors = {
        navController.navigate(routes.AUTHORS_ROUTE)
    }

    val optionsToFavorites = {
        navController.navigate(routes.FAVORITES_ROUTE)
    }

    val optionsToSettings = {
        navController.navigate(routes.SETTINGS_ROUTE)
    }

    val optionsToIntro = {
        navController.navigate(routes.INTRO_ROUTE)
    }

    val navigateToOptions = {
        navController.navigate(routes.OPTIONS_ROUTE)
    }

    val navigateToOffline = {
        navController.navigate(routes.OFFLINE_ROUTE)
    }
